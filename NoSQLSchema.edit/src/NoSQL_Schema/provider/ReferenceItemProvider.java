...
/**
 * This is the item provider adapter for a {@link NoSQL_Schema.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NoSQL_SchemaPackage.Literals.REFERENCE__OPPOSITE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NoSQL_SchemaPackage.Literals.REFERENCE__REF_TO,
				 true,
				 false,
				 true,
				 null,
