...
/**
 * This is the item provider adapter for a {@link NoSQL_Schema.EntityVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityVersionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NoSQL_SchemaPackage.Literals.ENTITY_VERSION__VERSION_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 NoSQL_SchemaFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 NoSQL_SchemaFactory.eINSTANCE.createReference()));

		newChildDescriptors.add
			(createChildParameter
				(NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 NoSQL_SchemaFactory.eINSTANCE.createAggregate()));
	}
