...
/**
 * This is the item provider adapter for a {@link Extended_NoSQL_Schema.EntityVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityVersionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION__VERSION_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityVersion.class)) {
			case Extended_NoSQL_SchemaPackage.ENTITY_VERSION__VERSION_ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Extended_NoSQL_SchemaPackage.ENTITY_VERSION__PROPERTIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 Extended_NoSQL_SchemaFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 Extended_NoSQL_SchemaFactory.eINSTANCE.createReference()));

		newChildDescriptors.add
			(createChildParameter
				(Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION__PROPERTIES,
				 Extended_NoSQL_SchemaFactory.eINSTANCE.createAggregate()));
	}
