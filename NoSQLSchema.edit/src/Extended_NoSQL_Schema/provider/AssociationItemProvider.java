...
/**
 * This is the item provider adapter for a {@link Extended_NoSQL_Schema.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider extends PropertyItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Extended_NoSQL_SchemaPackage.Literals.ASSOCIATION__LOWER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Extended_NoSQL_SchemaPackage.Literals.ASSOCIATION__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Association.class)) {
			case Extended_NoSQL_SchemaPackage.ASSOCIATION__LOWER_BOUND:
			case Extended_NoSQL_SchemaPackage.ASSOCIATION__UPPER_BOUND:
