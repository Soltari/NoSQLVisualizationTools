 ...
 * </p>
 * <ul>
 *   <li>{@link NoSQL_Schema.impl.AggregateImpl#getRefTo <em>Ref To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateImpl extends AssociationImpl implements Aggregate {
	...
	protected EClass eStaticClass() {
		return NoSQL_SchemaPackage.Literals.AGGREGATE;
	}
	...
	public EList<EntityVersion> getRefTo() {
		if (refTo == null) {
			refTo = new EObjectResolvingEList<EntityVersion>(EntityVersion.class, this, NoSQL_SchemaPackage.AGGREGATE__REF_TO);
		}
		return refTo;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NoSQL_SchemaPackage.AGGREGATE__REF_TO:
				return getRefTo();
		}
