 ...
 * </p>
 * <ul>
 *   <li>{@link NoSQL_Schema.impl.ReferenceImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link NoSQL_Schema.impl.ReferenceImpl#getRefTo <em>Ref To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends AssociationImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return NoSQL_SchemaPackage.Literals.REFERENCE;
	}
		...
		if (opposite != null && opposite.eIsProxy()) {
			...
			if (opposite != oldOpposite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NoSQL_SchemaPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
			}
		}
		return opposite;
	}
	...
	public void setOpposite(Reference newOpposite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NoSQL_SchemaPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
	}
	...
	public Entity getRefTo() {
		if (refTo != null && refTo.eIsProxy()) {
			...
			if (refTo != oldRefTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NoSQL_SchemaPackage.REFERENCE__REF_TO, oldRefTo, refTo));
			}
		}
		return refTo;
	}
	...
	public void setRefTo(Entity newRefTo) {
		...
		refTo = newRefTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NoSQL_SchemaPackage.REFERENCE__REF_TO, oldRefTo, refTo));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NoSQL_SchemaPackage.REFERENCE__OPPOSITE:
				if (resolve) return getOpposite();
				return basicGetOpposite();
			case NoSQL_SchemaPackage.REFERENCE__REF_TO:
