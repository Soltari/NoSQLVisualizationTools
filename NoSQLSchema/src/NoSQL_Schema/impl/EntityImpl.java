 ...
 * </p>
 * <ul>
 *   <li>{@link NoSQL_Schema.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link NoSQL_Schema.impl.EntityImpl#getEntityversions <em>Entityversions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	protected EClass eStaticClass() {
		return NoSQL_SchemaPackage.Literals.ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NoSQL_SchemaPackage.ENTITY__NAME, oldName, name));
	}
	...
	public EList<EntityVersion> getEntityversions() {
		if (entityversions == null) {
			entityversions = new EObjectContainmentEList<EntityVersion>(EntityVersion.class, this, NoSQL_SchemaPackage.ENTITY__ENTITYVERSIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NoSQL_SchemaPackage.ENTITY__ENTITYVERSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NoSQL_SchemaPackage.ENTITY__NAME:
				return getName();
			case NoSQL_SchemaPackage.ENTITY__ENTITYVERSIONS:
