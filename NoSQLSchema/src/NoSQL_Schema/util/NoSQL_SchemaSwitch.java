 ...
 * @generated
 */
public class NoSQL_SchemaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NoSQL_SchemaPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQL_SchemaPackage.TUPLE: {
			...
			case NoSQL_SchemaPackage.ASSOCIATION: {
			...
			case NoSQL_SchemaPackage.REFERENCE: {
			...
			case NoSQL_SchemaPackage.AGGREGATE: {
			...
			case NoSQL_SchemaPackage.PRIMITIVE_TYPE: {
