 ...
 * </p>
 * <ul>
 *   <li>{@link Extended_NoSQL_Schema.impl.EntityVersionImpl#getVersionId <em>Version Id</em>}</li>
 *   <li>{@link Extended_NoSQL_Schema.impl.EntityVersionImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityVersionImpl extends MinimalEObjectImpl.Container implements EntityVersion {
	...
	protected EClass eStaticClass() {
		return Extended_NoSQL_SchemaPackage.Literals.ENTITY_VERSION;
	}
	...
	public void setVersionId(int newVersionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Extended_NoSQL_SchemaPackage.ENTITY_VERSION__VERSION_ID, oldVersionId, versionId));
	}
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class, this, Extended_NoSQL_SchemaPackage.ENTITY_VERSION__PROPERTIES);
		}
		return properties;
	}
