 ...
 * </p>
 * <ul>
 *   <li>{@link Extended_NoSQL_Schema.impl.TupleImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleImpl extends TypeImpl implements Tuple {
	...
	protected EClass eStaticClass() {
		return Extended_NoSQL_SchemaPackage.Literals.TUPLE;
	}
	...
	public EList<Type> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Type>(Type.class, this, Extended_NoSQL_SchemaPackage.TUPLE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Extended_NoSQL_SchemaPackage.TUPLE__ELEMENTS:
