...
public class ObjGenerator
{
	...
	{
		schema = NoSQL_SchemaFactory.eINSTANCE.createNoSQLSchema();
		...
		{
			Entity oEntity = NoSQL_SchemaFactory.eINSTANCE.createEntity();
		...
		for (String entity : ENTITIES)
		{
			...
			{
				EntityVersion oev = NoSQL_SchemaFactory.eINSTANCE.createEntityVersion();
				...
				for (int j = 0; j < getRandomBetween(MIN_REF, MAX_REF); j++)
				{
					...
					Reference ref = NoSQL_SchemaFactory.eINSTANCE.createReference();
	...
	{
		Attribute attribute = NoSQL_SchemaFactory.eINSTANCE.createAttribute();
		PrimitiveType pType = NoSQL_SchemaFactory.eINSTANCE.createPrimitiveType();
	...
	private void generateTuples(EntityVersion oev, JsonObject strObj)
	{
		...
		{
			Attribute attribute = NoSQL_SchemaFactory.eINSTANCE.createAttribute();
			Tuple tuple = NoSQL_SchemaFactory.eINSTANCE.createTuple();
			...
			for (int k = 0; k < 5; k++)
				switch(random.nextInt(5))
				{
					...
					case 4:
					{
						if (random.nextBoolean())
						{
							Tuple anotherTuple = NoSQL_SchemaFactory.eINSTANCE.createTuple();
	...
	private void generateAggregates(EntityVersion oev, JsonObject strObj)
	{
		...
		{
			Aggregate aggr = NoSQL_SchemaFactory.eINSTANCE.createAggregate();
